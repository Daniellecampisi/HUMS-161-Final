...
label Creation_of_Bust:
    ...
    bust "I adorn her distinctive blue crown and intricate neckpiece. I was used as a sculptor’s model and a reference for other portraits of the queen."
...
label Attempt2moveBust:
    ...
    if(chance_moved == 1):
        scene city with fade
        narr "The Bust was successfully moved to another part of the city."
        narr "Due to its relocation, the Bust survived many centuries more buried under ancient sand."
...
label ANTIQUTIE_LAW:
    ...
    narr "Partage would let all artifacts of cultural significance to stay in Egypt while allowing Europeans to excavate and explore Egypt's ancient ruins."
    narr "What should be done?"
    ...
    menu: 
        ...
        "Reject the Antiquities Law of 1912.":
            ...
            if(chance_moved < 4):
                ...
                narr "The rejection of the law fails due to British influence in the Egyptian government."
    ...
    menu:
        "Investigate the artifact.":
            ...
            if(chance_moved > 6):
                ...
                narr "The investigation of the artifact succeeds and Egypt keeps the bust!"
...
label InGermayBust:
    ...
    bust "I was first publicly displayed in Berlin in 1924 and has siattemtnce become one of the most iconic artifacts of ancient Egypt."
    bust "I am currently housed in the Neues Museum, Berlin, and remain at the center of a longstanding dispute between Egypt and Germany over where my home should be."
    $chance_moved = random.randint(0,5)
    narr "Should Egypt attempt to negotiate with Germany?"
    menu:
        "Negotiate.":
            if(chance_moved > 3):
...
label outcome3BUST:
    ...
    bust "I was transferred to a museum in Germany, watching my people negotiate my stewardship and protect my longevity."
